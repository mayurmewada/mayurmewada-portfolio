...
const skillGroups = [
  {
    ...
    items: ["React.js", "Next.js", "TypeScript", "JavaScript", "Redux Toolkit", "Tailwind CSS", "Material UI", "Bootstrap", "SCSS"],
  },
  {
    icon: Server,
    title: "Backend",
  ...
  },
  {
    ...
    items: ["ChatGPT", "Prompt Engineering", "AI-assisted debugging", "Code generation"],
  },
];
      ...
      <div className="mx-auto max-w-6xl">
        ...
        <div className="grid gap-5 md:grid-cols-2">
          {skillGroups.map((group, groupIndex) => (
            ...
            >
              <div className={`absolute -top-20 -right-20 h-40 w-40 rounded-full bg-gradient-to-br ${group.color} opacity-10 blur-3xl transition-opacity group-hover:opacity-20`} />
              <div className="relative">
                <div className="mb-5 flex items-center gap-3">
                  <div className={`grid h-10 w-10 place-items-center rounded-xl bg-gradient-to-br ${group.color}`}>
                ...
                <div className="flex flex-wrap gap-2">
                  {group.items.map((skill, skillIndex) => (
                    <motion.span
                      ...
                      transition={{ delay: groupIndex * 0.05 + skillIndex * 0.03 }}
